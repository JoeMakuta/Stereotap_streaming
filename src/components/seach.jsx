      ...
      <div>
         ...
         <div
            ...
            <div >
               ...
               <div className=" w-[100%] flex gap-6 h-72 overflow-x-scroll hover:overscroll-contain mt-8 items-start justify-center flex-wrap ">
                  {
                     artistData.map((artist, index) => {
                        return (
                           <div key={index} className="w-52 bg-neutral-900 bg-opacity-5  hover:scale-105 transition-all  flex flex-col items-center  p-5 gap-5 rounded-2xl cursor-pointer hover:shadow-2xl " onClick={() => { fetchAlbums(artist.id) }} >
            ...
            <div className="flex gap-6 items-start justify-center flex-wrap ">
               {
                  albumData.map((album, index) => {
                     return (
                        <div key={index} className="w-52 hover:scale-105 bg-neutral-900 bg-opacity-5  transition-all flex flex-col  mt-4 rounded-2xl cursor-pointer hover:shadow-2xl shadow-green-600 " onClick={() => { displayIframe("album", album.id) }} >
