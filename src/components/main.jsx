...
function Main_left() {
   return <div className="w-1/2 flex flex-col gap-8 h-96 justify-center  m-20 pl-10 ">
      ...
      <div className=" flex gap-10 items-center" >
         <button className='w-40 h-10 border bg-mainColor text-white rounded-lg border-mainColor hover:bg-inherit hover:text-mainColor '>Get started</button>
...
function Main_right() {
   return <div className="w-1/2  ">
      <div className=" relative left-96 top-11 bg-yellow-300 rounded-xl w-32 text-center p-3 h-20 ">
